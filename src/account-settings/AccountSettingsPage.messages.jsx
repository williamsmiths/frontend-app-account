...
const messages = defineMessages({
  ...
  'account.settings.banner.beta.language': {
    ...
    defaultMessage: 'Bạn đã đặt ngôn ngữ của mình thành {beta_language}, ngôn ngữ này hiện chưa được dịch đầy đủ. Bạn có thể giúp chúng tôi dịch đầy đủ ngôn ngữ này bằng cách tham gia cộng đồng Transifex và thêm các bản dịch từ tiếng Anh cho những người học nói {beta_language}.',
  ...
  'account.settings.banner.beta.language.action.switch.back': {
    ...
    defaultMessage: 'Chuyển về {previous_language}',
  ...
  'account.settings.section.linked.accounts.description': {
    ...
    defaultMessage: 'Bạn có thể liên kết các tài khoản nhận dạng của mình để đơn giản hóa việc đăng nhập vào {siteName}.',
  ...
  'account.settings.field.username.help.text': {
    ...
    defaultMessage: 'Tên nhận dạng bạn trên {siteName}. Bạn không thể thay đổi tên người dùng của mình.',
  ...
  'account.settings.field.name.verified.help.text.verified': {
    ...
    defaultMessage: 'Tên này đã được xác minh bằng ID hình ảnh.',
  ...
  'account.settings.field.name.verified.help.text.verified.proctored': {
    ...
    defaultMessage: 'Tên này đã được xác minh bằng cách giám sát.',
  ...
  'account.settings.field.name.verified.help.text.verified.certificate': {
    ...
    defaultMessage: 'Tên này đã được xác minh bằng ID hình ảnh, và được chọn để xuất hiện trên chứng chỉ và hồ sơ công khai của bạn.',
  ...
  'account.settings.field.name.verified.help.text.verified.proctored.certificate': {
    ...
    defaultMessage: 'Tên này đã được xác minh bằng cách giám sát, và được chọn để xuất hiện trên chứng chỉ và hồ sơ công khai của bạn.',
  ...
  'account.settings.field.name.verified.help.text.submitted': {
    ...
    defaultMessage: 'Yêu cầu xác minh đã được gửi. Điều này thường mất từ 48 giờ trở xuống. Tên đã xác minh không thể thay đổi vào lúc này.',
  ...
  'account.settings.field.name.verified.help.text.submitted.proctored': {
    ...
    defaultMessage: 'Kỳ thi có giám sát của bạn đã được gửi. Tên đã xác minh không thể thay đổi vào lúc này. Vui lòng kiểm tra lại sau 2-5 ngày.',
  ...
  'account.settings.field.name.verified.help.text.submitted.proctored.certificate': {
    ...
    defaultMessage: 'Khi kỳ thi có giám sát của bạn vượt qua đánh giá, tên này sẽ xuất hiện trên chứng chỉ và hồ sơ công khai của bạn. Tên đã xác minh không thể thay đổi vào lúc này.',
  ...
  'account.settings.field.full.name.help.text.submitted': {
    ...
    defaultMessage: 'Yêu cầu xác minh đã được gửi. Điều này thường mất từ 48 giờ trở xuống. Họ và tên không thể thay đổi vào lúc này.',
  ...
  'account.settings.field.full.name.help.text.submitted.proctored': {
    ...
    defaultMessage: 'Kỳ thi có giám sát của bạn đã được gửi. Họ và tên không thể thay đổi vào lúc này. Vui lòng kiểm tra lại sau 2-5 ngày.',
  ...
  'account.settings.field.full.name.help.text.submitted.proctored.certificate': {
    ...
    defaultMessage: 'Khi kỳ thi có giám sát của bạn vượt qua đánh giá, tên này sẽ xuất hiện trên chứng chỉ và hồ sơ công khai của bạn. Họ và tên không thể thay đổi vào lúc này.',
    description: 'Help text for the account settings full name field when a full name has been submitted and will appear on certificates.',
  },
  ...
  'account.settings.field.name.verified.failure.message': {
    ...
    defaultMessage: 'Nỗ lực xác minh danh tính gần đây nhất của bạn đã không thành công. Các cài đặt tài khoản liên quan đã được khôi phục.',
  ...
  'account.settings.field.name.verified.failure.message.help.link': {
    ...
    defaultMessage: 'Tìm hiểu thêm về xác minh ID',
  ...
  'account.settings.field.name.verified.submitted.message': {
    ...
    defaultMessage: 'Yêu cầu xác minh danh tính của bạn đã được gửi và thường mất từ 24 đến 48 giờ để hoàn thành.',
  ...
  'account.settings.field.name.verified.submitted.message.certificate': {
    ...
    defaultMessage: 'Khi yêu cầu của bạn được chấp thuận, tên đã cập nhật của bạn sẽ xuất hiện trên tất cả các chứng chỉ và hồ sơ công khai liên quan.',
  ...
  'account.settings.field.name.verified.submitted.message.header': {
    ...
    defaultMessage: 'Yêu cầu thay đổi tên của bạn gần như đã hoàn tất!',
  ...
  'account.settings.field.email.confirmation': {
    ...
    defaultMessage: 'Chúng tôi đã gửi một tin nhắn xác nhận đến {value}. Nhấp vào liên kết trong tin nhắn để cập nhật địa chỉ email của bạn.',
  ...
  'account.settings.field.email.help.text': {
    ...
    defaultMessage: 'Bạn nhận được tin nhắn từ {siteName} và các nhóm khóa học tại địa chỉ này.',
  ...
  'account.settings.field.secondary.email.confirmation': {
    ...
    defaultMessage: 'Chúng tôi đã gửi một tin nhắn xác nhận đến {value}. Nhấp vào liên kết trong tin nhắn để cập nhật địa chỉ email khôi phục của bạn.',
  ...
  'account.settings.email.field.confirmation.header': {
    ...
    defaultMessage: 'Chỉ một bước nữa!',
  ...
  'account.settings.field.year_of_birth.options.empty': {
    ...
    defaultMessage: 'Chọn một năm sinh',
  ...
  'account.settings.field.dob.form.help.text': {
    ...
    defaultMessage: 'Chúng tôi yêu cầu thông tin về tháng và năm sinh để giúp chúng tôi tuân thủ các nghĩa vụ pháp lý của mình.',
  ...
  'account.settings.field.month_of_birth.options.empty': {
    ...
    defaultMessage: 'Chọn một tháng sinh',
  ...
  'account.settings.field.country.options.empty': {
    ...
    defaultMessage: 'Chọn một Quốc gia',
  ...
  'account.settings.field.state.options.empty': {
    ...
    defaultMessage: 'Chọn một Tiểu bang',
  ...
  'account.settings.field.site.language.help.text': {
    ...
    defaultMessage: 'Ngôn ngữ được sử dụng trên toàn trang web này. Trang web này hiện chỉ có sẵn bằng một số ngôn ngữ hạn chế.',
  ...
  'account.settings.field.education.levels.empty': {
    ...
    defaultMessage: 'Chọn một trình độ học vấn',
  ...
  'account.settings.field.education.levels.m': {
    ...
    defaultMessage: 'Bằng thạc sĩ hoặc bằng chuyên nghiệp',
  ...
  'account.settings.field.gender.options.empty': {
    ...
    defaultMessage: 'Chọn một giới tính',
  ...
  'account.settings.field.language.proficiencies.empty': {
    ...
    defaultMessage: 'Thêm một ngôn ngữ nói',
  ...
  'account.settings.field.language_proficiencies.options.empty': {
    ...
    defaultMessage: 'Chọn một Ngôn ngữ',
  ...
  'account.settings.field.time.zone.description': {
    ...
    defaultMessage: 'Chọn múi giờ để hiển thị ngày khóa học. Nếu bạn không chỉ định múi giờ, ngày khóa học, bao gồm cả thời hạn bài tập, sẽ được hiển thị theo múi giờ địa phương của trình duyệt của bạn.',
  ...
  'account.settings.field.time.zone.all': {
    ...
    defaultMessage: 'Tất cả các múi giờ',
  ...
  'account.settings.section.social.media.description': {
    ...
    defaultMessage: 'Tùy chọn, liên kết các tài khoản cá nhân của bạn với các biểu tượng mạng xã hội trên hồ sơ {siteName} của bạn.',
  ...
  'account.settings.static.field.empty': {
    ...
    defaultMessage: 'Chưa có giá trị nào được thiết lập. Liên hệ với quản trị viên {enterprise} của bạn để thực hiện thay đổi.',
  ...
  'account.settings.static.field.empty.no.admin': {
    ...
    defaultMessage: 'Chưa có giá trị nào được thiết lập.',
