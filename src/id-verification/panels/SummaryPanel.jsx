    ...
    return (
      <p id="profile-manager-warning">
        <FormattedMessage
          ...
          defaultMessage="Cài đặt tài khoản của bạn được quản lý bởi {managerTitle}. Nếu tên trên giấy tờ tùy thân của bạn không khớp với tên trên tài khoản, vui lòng liên hệ với quản trị viên {profileDataManager} hoặc {support} để được trợ giúp."
  ...
  function getError() {
    ...
    return (
      <FormattedMessage
        ...
        defaultMessage={`
          Chúng tôi gặp lỗi kỹ thuật trong quá trình xác minh danh tính.
          Đây có thể là sự cố tạm thời, vui lòng thử lại sau vài phút.
          Nếu sự cố vẫn tiếp diễn, vui lòng truy cập {support_link} để được trợ giúp.
        `}
        values={{
          support_link: (
