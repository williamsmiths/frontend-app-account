...
const messages = defineMessages({
  'account.settings.cannot.delete.account.text': {
    ...
    defaultMessage: 'Xin lưu ý rằng, vì mục đích tuân thủ pháp luật và quy định, việc xóa tài khoản hiện không có sẵn.',
  ...
  'account.settings.delete.account.subheader': {
    ...
    defaultMessage: 'Chúng tôi rất tiếc khi bạn rời đi!',
  ...
  'account.settings.delete.account.text.2': {
    ...
    defaultMessage: 'Sau khi tài khoản của bạn bị xóa, bạn không thể sử dụng nó để tham gia các khóa học trên {siteName}.',
    description: 'A message in the user account deletion area',
  },
  'account.settings.delete.account.text.2.edX': {
    id: 'account.settings.delete.account.text.2.edX',
    defaultMessage: 'Sau khi tài khoản của bạn bị xóa, bạn không thể sử dụng nó để tham gia các khóa học trên ứng dụng edX, edx.org hoặc bất kỳ trang web nào khác do edX lưu trữ. Điều này bao gồm quyền truy cập vào edx.org từ hệ thống của chủ lao động hoặc trường đại học của bạn và quyền truy cập vào các trang web riêng do MIT Open Learning, Wharton Executive Education và Harvard Medical School cung cấp.',
    description: 'A message in the user account deletion area',
  },
  ...
  'account.settings.delete.account.text.warning': {
    ...
    defaultMessage: 'Cảnh báo: Việc xóa tài khoản là vĩnh viễn. Vui lòng đọc kỹ những điều trên trước khi tiếp tục. Đây là một hành động không thể đảo ngược và bạn sẽ không còn có thể sử dụng cùng một email trên {siteName}.',
    description: 'A message in the user account deletion area',
  },
  'account.settings.delete.account.text.change.instead': {
    id: 'account.settings.delete.account.text.change.instead',
    defaultMessage: 'Bạn muốn thay đổi email, tên hoặc mật khẩu của mình thay vào đó?',
    description: 'A message in the user account deletion area',
  },
  ...
  'account.settings.delete.account.please.unlink': {
    ...
    defaultMessage: 'hủy liên kết tất cả các tài khoản mạng xã hội',
  ...
  'account.settings.delete.account.modal.text.2': {
    ...
    defaultMessage: 'Nếu bạn tiếp tục, bạn sẽ không thể sử dụng tài khoản này để tham gia các khóa học trên {siteName}.',
    description: 'Messaging in the dialog asking user to confirm that they want to delete their entire account',
  },
  'account.settings.delete.account.modal.text.2.edX': {
    id: 'account.settings.delete.account.modal.text.2.edX',
    defaultMessage: 'Nếu bạn tiếp tục, bạn sẽ không thể sử dụng tài khoản này để tham gia các khóa học trên ứng dụng edX, edx.org hoặc bất kỳ trang web nào khác do edX lưu trữ. Điều này bao gồm quyền truy cập vào edx.org từ hệ thống của chủ lao động hoặc trường đại học của bạn và quyền truy cập vào các trang web riêng do MIT Open Learning, Wharton Executive Education và Harvard Medical School cung cấp.',
    description: 'Messaging in the dialog asking user to confirm that they want to delete their entire account',
  },
  ...
  'account.settings.delete.account.error.unable.to.delete.details': {
    ...
    defaultMessage: 'Xin lỗi, đã có lỗi khi xử lý yêu cầu của bạn. Vui lòng thử lại sau.',
    description: 'Error message when account deletion failed',
  },
  'account.settings.delete.account.modal.after.header': {
    id: 'account.settings.delete.account.modal.after.header',
    defaultMessage: 'Chúng tôi rất tiếc khi bạn rời đi! Tài khoản của bạn sẽ sớm bị xóa.',
  ...
  'account.settings.delete.account.modal.after.text': {
    ...
    defaultMessage: 'Việc xóa tài khoản, bao gồm cả việc xóa khỏi danh sách email, có thể mất vài tuần để xử lý hoàn toàn thông qua hệ thống của chúng tôi. Nếu bạn muốn hủy đăng ký email trước đó, vui lòng hủy đăng ký từ chân trang của bất kỳ email nào.',
